      ...
      <Component
        ...
        className={clsxm(
          ...
          [
            ...
            variant === 's1' && ['font-averta text-lg font-medium'],
            variant === 's2' && ['font-averta text-base font-medium'],
            variant === 's3' && ['font-averta text-sm font-medium'],
            variant === 's4' && ['font-averta text-xs font-medium'],
            variant === 'b1' && ['font-averta text-lg'],
            variant === 'b2' && ['font-averta text-base'],
            variant === 'b3' && ['font-averta text-sm font-normal'],
            variant === 'c1' && ['font-averta text-xs'],
            variant === 'c2' && ['font-averta text-[11px] leading-[14px]'],
          ],
          //#endregion  //*======== Variants ===========
          //#region  //*=========== Color ===========
          [
